...
\subsubsection{Website (RPSRview)}
    The website fulfills the following roles:\\
		...
		EF1 & Log in to website using password for administrative privileges\\
		EF2 & Add a species to a recording \\
    		EF3 & Allow the user to enter data for each species\\
		EF4 & Enables user to edit and remove existing specimen record details \\
        \end{tabular}
