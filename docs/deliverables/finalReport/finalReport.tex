...
\newcommand\titleText{Final Report}
\newcommand\reference{SE\_O2\_FP\_01}
...
\begin{document}
    ...
    \section{End of Project Report}
        \input{finalState/finalState.tex}

    \section{Team Performance}
        \input{teamPerformance/teamPerformance.tex}

    \section{Test Report}
        \input{testReport/testReport.tex}

    \section{Maintenance Manual}
        \input{maintenanceManual/maintenanceManual.tex}

    \section{Document History}
        \begin{tabular}{l || p{8cm} | l | r}
            Version & Edit & Date & Persons \\ \hline 
            0.1 & Initial Version & Febuary 12 2015 & nid21 \\
            0.2 & Document Reviewed & Febuary 13 2015 & nid21 \\
            0.3 & Included personal reports, project history, management study & Febuary 15 2015 & nid21 \\
            0.4 & added test tables & Febuary 16 2015 & nid21 \\
